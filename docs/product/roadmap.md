...
6. **Paridade comercial (Fase A)** ✓ — planos, cobrança/Pix mock+MP, carteirinha
   verificável, LGE, home do sócio: `docs/data/modulo-associacao.md` e
   `docs/product/plano-paridade-concorrentes.md`. Fase B parcial (export CSV,
   recibo, dismiss, check-in QR).

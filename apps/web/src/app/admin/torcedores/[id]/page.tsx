...
import { AdminMembroSedeForm } from '@/app/admin/membros/admin-membro-sede-form'
import { MemberActions } from '@/components/admin/member-actions'
import { MotionReveal } from '@/components/motion/motion-reveal'
import { AdminDetailHeader, StatusBadge } from '@/components/admin/ui'
import type { Metadata } from 'next'

export const metadata: Metadata = { title: 'Torcedor — Admin' }

type Props = { params: Promise<{ id: string }> }

export default async function TorcedorDetalhePage({ params }: Props) {
